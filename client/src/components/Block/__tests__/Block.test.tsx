...
it('renders without crashing', () => {
  render(<Block block={mockBlock}/>, div);
...
it('should render the correct hash', () => {
  ...
  expect(hash).toBe('814b3029bd77083dca0ce61e189a96a00cfa60dc2dddf0c7f2ab42e4a9b51e60');
});
